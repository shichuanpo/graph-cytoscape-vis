(function (e) {
    function t(t) {
        for (var r, o, c = t[0], i = t[1], l = t[2], s = 0, f = []; s < c.length; s++) o = c[s],
        u[o] && f.push(u[o][0]),
        u[o] = 0;
        ...
        var f = new s["a"]({
                routes: [{
                    ...
                    children: [{
                        ...
                        name: "cytoscape",
                        component: function () {
                            return n.e("about").then(n.bind(null, "a9f5"))
                        }
                    },
                    {
                        path: "/vis",
                        name: "vis",
                        component: function () {
                            return n.e("about").then(n.bind(null, "7397"))
                        }
                    }]
                }]
            }),
...
//# sourceMappingURL=app.372ad16d.js.map